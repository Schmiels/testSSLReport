...
def evaluateCiphers(fileName):
    fName, fType = os.path.splitext(fileName)
    cipherList = parseFile(fType, fName)
    ...
    weakF = open("output/" + outputPrefix + "_weak.txt", "w")
    secureF = open("output/" + outputPrefix + "_secure.txt", "w")
    ...
    for cipher in cipherList:
        ...
        if r.ok:
            ...
            if secVal == "insecure" or secVal == "weak":
                ...
                print("Unsupported " + DATA_PARAM + " value")
        else:
